...
|---|---|---|
| `chirik-server` | `0.0.0.0:8080` | сайт, API и внешний SSE-маршрут `/events` |
...
В зависимости от версии Cloudpub настройка выполняется в приложении, личном кабинете или CLI. В любом случае значение локального target должно быть `127.0.0.1:8080`.
...
CHIRIK_SERVER_ADDR             внешний локальный порт, по умолчанию 0.0.0.0:8080
